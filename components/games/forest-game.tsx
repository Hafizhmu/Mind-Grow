...
export function ForestGame() {
  ...
  const [audioElements] = useState(() => {
    ...
    const river = new Audio("/sounds/river.mp3");
    const squirrel = new Audio("/sounds/squirrel.mp3");

    squirrel.volume = 1; // volume 50% (default 1.0)
    birds.volume = 0.7; // volume 50% (default 1.0)
    river.volume = 0.5; // volume 50% (default 1.0)

    return { birds, river, squirrel };
  });
